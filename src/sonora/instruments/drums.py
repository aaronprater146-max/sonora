...
KITS = {
    ...
    "drowning": {"kick": dict(tune=31, decay=0.58, punch=0.9, click=0.45, sub=0.78),
                 "snare": dict(tune=152, decay=0.30, wires=0.9, crack=0.95, room=0.26),
                 "hat": dict(tone=0.95, level=0.80),
                 "openhat": dict(tone=1.0, level=0.58),
                 "rim": dict(),
                 "tom": dict(tune=104),
                 "cowbell": dict(),
                 "tamb": dict(),
                 "ride": dict(decay=2.0),
                 "crash": dict(decay=2.6)},
