...
KITS = {
    ...
    "groove": {"kick": dict(tune=32, decay=0.40, punch=1.0, click=0.70, sub=0.85),
               "snare": dict(tune=172, decay=0.16, wires=0.80, crack=1.0, room=0.03),
               "hat": dict(tone=1.15, level=0.48),
               "rim": dict(),
               "tom": dict(tune=115),
    ...
    "drowning": {"kick": dict(tune=33, decay=0.32, punch=1.0, click=0.7, sub=0.72),
                 ...
                 "hat": dict(tone=1.0, level=0.46),
                 "openhat": dict(tone=1.05, level=0.34),
                 "rim": dict(),
                 "tom": dict(tune=112),
                 "cowbell": dict(),
                 "tamb": dict(),
                 "ride": dict(decay=0.7),
                 "crash": dict(decay=0.8)},
...
STYLE_GRIDS = {
    ...
    "drowning": {"kick": "x.......x.......",
                 ...
                 "hat": "..o...o...o...o.",
                 "crash": "x..............."},
    "drowning_drive": {"kick": "x.......x...x...",
                       "snare": "....x.......x..g",
                       "hat": "..o.o.o.o.o.o.o.",
                       "rim": "......o.......o.",
                       "tom": ".............o..",
                       "crash": "x..............."},
    "drowning_break": {"kick": "x...............",
                       "snare": "........x.......",
                       "hat": "............o..."},
    "drowning_intro": {"kick": "x.......x.......",
                       "snare": "............x...",
                       "hat": "....o.......o..."},
